...
///////////////// save flie////////////////////////
  ...
  startBluetoothConnectionfinger() async {
    ...
    _scanResultsSubscription =
      ...
      if (results.isNotEmpty) {
        ...
        if (scanResult.device.remoteId.toString() == globals.macaddress.toUpperCase()) {
          //if (scanResult.device.advName.toString() == "PRT Server") {
          // print(
          //     '${scanResult.device.remoteId}: "${scanResult.advertisementData.advName}" ป่ะละะะะะะะะะะะะะะะะะะะะะะะะะะะะะะ!');
  ...
  Future<void> saveListToFile() async {
    try {
      ...
      String fullname =
          "${downloadsDirectory}/Inhaler_log_${globals.csv_file_name}_${globals.namedevice}.csv";
      print(fullname);
